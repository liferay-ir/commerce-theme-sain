...
package com.sain.commerce.themes.sain.internal.product.renderer.list.entry;
...
@Component(
	immediate = true,
	property = {
		"commerce.product.content.list.entry.renderer.key=" + SainCPContentListEntryRenderer.KEY,
...
public class SainCPContentListEntryRenderer
	implements CPContentListEntryRenderer {

	public static final String KEY = "list-entry-sain";
	...
	public void render(
		...
		String moduleName = _npmResolver.resolveModuleName(
			"commerce-theme-sain-impl/product_card/SainProductCard.es");
		...
		ComponentDescriptor componentDescriptor = new ComponentDescriptor(
			"SainProductCard.render", moduleName, null, dependencies, false, true,
			false);
