...
import template from './SainProductsCompare.soy';
import Component from 'metal-component';
import Soy, {Config} from 'metal-soy';

import './SainProductsCompareItem.es';

class SainProductsCompare extends Component {
...
Soy.register(SainProductsCompare, template);

SainProductsCompare.STATE = {
...
export {SainProductsCompare};
export default SainProductsCompare;
