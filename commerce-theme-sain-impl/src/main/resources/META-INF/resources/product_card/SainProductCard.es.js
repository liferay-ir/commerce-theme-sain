...
import template from './SainProductCard.soy';
...
class SainProductCard extends Component {
...
Soy.register(SainProductCard, template);

SainProductCard.STATE = {
...
export {SainProductCard};
export default SainProductCard;